...
namespace ForeRunners.Devices.Design {
    public class CoreControls{
        ...
        public virtual void deleteControl() { throw new NotImplementedException(); }
        ...
        private void DeleteToolStripMenuItem_Click(object sender, EventArgs e) {
            if (MessageBox.Show("Are you sure want to remove?", "Gruhapathi Control Panel", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes) {
