    ...
    */
    ...
    public class Calender {
        ...
        public Calender(MetroForm frmOwner, Point location, int startYear = 2016) {
            ...
            date = selectedYear + "-" + selectedMonthIndex + 1 + "-" + selectedDay;
        ...
        private void LblNext_Click(object sender, EventArgs e) {
            ...
            date = selectedYear + "-" + getMonthInNumber() + "-" + selectedDay;
        ...
        private void Day_Click(object sender, EventArgs e) {
            ...
            date = con.Controls.Find("lblYear", true)[0].Text + "-" + (selectedMonthIndex+1) + "-" + label.Text;
