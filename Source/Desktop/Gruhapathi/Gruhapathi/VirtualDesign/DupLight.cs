...
namespace Gruhapathi.VirtualDesign {
    public class DupLight : Light {
        ...
        public DupLight(Panel mainPanel, MetroForm owner, bool power = false) : base(mainPanel, power) {
            this.owner = owner;

            deviceDiag = new DeviceDialog(owner, new Point(0, 0), Off_Click, On_Click, More_Click, "light_off");
        ...
        public override void control_Click(object sender, MouseEventArgs e) {
            ...
            deviceDiag.DialogIcon = "light_off";
            deviceDiag.showDialog();
        }

        public override void deleteControl() {
            MessageBox.Show("Light asdasd");
        }
        ...
        private void On_Click(object sender, MouseEventArgs e) {
            ...
            string loc = string.Format("{0},{1}", lightLocation.X, lightLocation.Y);
